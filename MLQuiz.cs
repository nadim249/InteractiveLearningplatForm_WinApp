...
{
    public partial class MLQuiz : Form
    {
        private string userName;
        private int userID;
        private int quizID;
        private int timeLeft = 60;
        public MLQuiz(string name, int id)
        {
            InitializeComponent();
            userName = name;
            userID = id;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            MLCourseVideo mlVideo = new MLCourseVideo(userName, userID);
            mlVideo.Show();
            this.Hide();
        ...
        private void MLQuiz_Load(object sender, EventArgs e)
        {
            quizTimer.Start();
        }
